...
const themeVariables = lessToJs(fs.readFileSync(path.join(__dirname, './app/assets/css/common/ant-theme-vars.less'), 'utf8'));
...
module.exports = {
    ...
    entry: [
        'babel-polyfill',
        'webpack-dev-server/client?http://localhost:9013',
